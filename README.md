...
Visualize your generated data with interactive charts:
...
Features:
- Interactive file selection from data folder
- Multiple chart types (single, comparison, advanced)
- Export to high-quality PNG files
- Technical analysis with moving averages and volume
...
├── GRAPH_GEN/                   # Graph generation tools
│   ├── btc_graph_generator.py   # Interactive graph generator
│   ├── launcher.py              # Simple launcher
│   ├── example_usage.py         # Usage examples
│   └── launch_graph_generator.bat # Windows launcher
